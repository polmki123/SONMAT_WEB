...
function format_date(date_time){
    ...
    //console.log("date_time 1 : ", date_time.toLocaleString() + "  < " + date_time.getTime() + ", " + date_time.getTimezoneOffset());

    var SEOUL_TIME_OFF_SET = 9;
    date_time = new Date(date_time.getTime() + (3600000*SEOUL_TIME_OFF_SET));

    //console.log("date_time 2 : ", new_date_time.toLocaleString() + "  < " + new_date_time.getTime() + ", " + new_date_time.getTimezoneOffset());
